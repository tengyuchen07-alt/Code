...
void Input::print() {
	if (result_int != "0" && !positive)cout << "-";
	cout << result_int;
    if (result_double != "0"&& result_double != "") {
        cout << ".";
        cout << result_double;
	}
	cout <<"("<< target_base << ")" << endl;
}
